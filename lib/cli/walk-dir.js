...
let fs = require('fs');
let Type = require('../typeOf');//这里不适用node-util检查，因为官方提示很多isXXX方法会过时
let fileExistSync = fs.existsSync || path.existsSync;
...
function dir2Json(rootPath,options) {
    ...
    let filterFile = exclude.file || false;
    let filterDir = exclude.directory || false;
