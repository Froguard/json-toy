...
```js
['├ ROOT', undefined][('│ ', '│   ')][('│ ', '├─ one', undefined)][('│ ', '│   ', '│   ')][('│ ', '│   ', '├─ two', ': "2"')][('│ ', '│   ', '│   ', undefined)][
  ('│ ', '│   ', '├─ three', undefined)
][('│ ', '│   ', '│   ', '│   ')][('│ ', '│   ', '│   ', '├─ four', undefined)][('│ ', '│   ', '│   ', '│   ', '│   ')][('│ ', '│   ', '│   ', '│   ', '├─ five', ': 5')][
  ('│ ', '│   ', '│   ', '│   ', '│   ', undefined)
][('│ ', '│   ', '├─ six', undefined)][('│ ', '│   ', '│   ', '│   ')][('│ ', '│   ', '│   ', '├─ seven', ': 7')][('│ ', '│   ', '│   ', '│   ', undefined)][
  ('│ ', '│   ', '├─ eight', undefined)
][('│ ', '│   ', '│   ', '│   ')][('│ ', '│   ', '│   ', '├─ nine', ': 9')][('│ ', '│   ', '│   ', '│   ', undefined)][('│ ', '├─ ten', undefined)][('│ ', '│   ', '│   ')][
  ('│ ', '│   ', '├─ eleven', ': 11')
][('│ ', '│   ', '│   ', undefined)][('│ ', '├─ twelve', ': 12')][('│ ', '│   ', undefined)];
```
